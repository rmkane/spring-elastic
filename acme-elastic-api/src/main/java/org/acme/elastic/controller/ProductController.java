...
import org.acme.elastic.service.ProductService;
...
public class ProductController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "All products (empty if index does not exist yet)", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Product.class))))
    })
    @GetMapping
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Products whose categoryIds contain any of the given ids", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Product.class)))),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Created (no id in body)", content = @Content(schema = @Schema(implementation = Product.class))),
            @ApiResponse(responseCode = "200", description = "Updated or saved with client id", content = @Content(schema = @Schema(implementation = Product.class)))
    })
    @PostMapping
